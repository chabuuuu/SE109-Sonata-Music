        ...
        <aside className="w-48 h-screen pb-24 bg-gradient-to-b from-[#39639D] to-black flex flex-col justify-between">
          ...
          <div>
            ...
            <nav className="flex-1 pt-2">
              <ul>
                ...
                <li className="px-4 py-3 flex items-center gap-4 text-gray-300 hover:bg-slate-500 rounded-sm">
                  <img src="/layout_imgs/createPlaylist_logo.png" alt="create playlist logo" className="w-5 h-5" />
          ...
          <div className="p-4 text-xs border-t border-gray-700">
            <div className="grid grid-cols-2 gap-2">
              ...
              <Link href="/privacy" className="text-gray-400 hover:text-white">Privacy Center</Link>
            ...
            <div className="mt-4">
              <button className="border border-gray-700 rounded-full py-1 px-3 text-sm text-gray-300 flex items-center hover:bg-slate-700">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" /></svg>
