        ...
        <nav className="flex-1 pt-2">
          <ul>
            <li className="px-6 py-3 flex items-center gap-5 text-gray-300 hover:bg-slate-500 rounded-sm">
              <img src="/layout_imgs/dashboard-icon.svg" alt="home logo" />
              Dashboard
            </li>
            <li className="px-6 py-3 flex items-center gap-5 text-gray-300 hover:bg-slate-500 rounded-sm">
              <img src="/layout_imgs/unchosen-admin-icon.svg" alt="Artists Management" />
              Artists Management
            </li>
            <li className="px-6 py-3 flex items-center gap-5 text-gray-300 hover:bg-slate-500 rounded-sm">
              <img src="/layout_imgs/unchosen-admin-icon.svg" alt="Album Management" />
              Album Management
            </li>
            <li className="px-6 py-3 flex items-center gap-5 text-gray-300 hover:bg-slate-500 rounded-sm">
              <img src="/layout_imgs/unchosen-admin-icon.svg" alt="Categories Management" />
              Categories Management
            </li>
            <li className="px-6 py-3 flex items-center gap-5 text-gray-300 hover:bg-slate-500 rounded-sm">
              <img src="/layout_imgs/chosen-admin-icon.svg" alt="Song Requests" />
              Song Requests
            </li>
          </ul>
        </nav>
