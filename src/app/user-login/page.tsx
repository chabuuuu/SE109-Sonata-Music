        ...
        <div className="w-full max-w-md p-8 bg-[#F0E6D6] border border-[#D3B995] rounded-lg shadow-lg">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between text-sm">
              <a
                href="#"
                className="text-[#A67C52] font-semibold hover:text-[#C8A97E] transition-colors"
              >
            ...
            <button
              type="submit"
              className={`w-full bg-[#C8A97E] hover:bg-[#A67C52] text-white py-3 rounded-md font-semibold transition-colors shadow-md ${
            ...
            <a href="./contributor/login" className="hover:text-white">
              {" "}
              A contributor? Click here.
            </a>
          </form>
