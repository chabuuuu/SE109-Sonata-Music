        ...
        <div className="px-8 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="p-5 flex flex-col h-full">
                <div className="flex-1">
                  <div className="text-sm opacity-80 mb-1 text-white">
                    {playlistsData[0].artists.map((artist, index) => (
                      <span key={index}>
                        {artist}{index < playlistsData[0].artists.length - 1 ? " • " : ""}
                      </span>
                    ))}
                  </div>
                  <h2 className="text-5xl font-bold mb-2 text-white">{playlistsData[0].title}</h2>
                  <p className="text-sm opacity-80 text-white">{playlistsData[0].description}</p>
                </div>
              </div>
            </div>
            ...
            {playlistsData.slice(1, 4).map((playlist) => (
              <div key={playlist.id} className={`${playlist.color} rounded-lg overflow-hidden p-4 flex flex-col text-white`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {playlistsData.slice(4).map((playlist) => (
              <div key={playlist.id} className="bg-gray-100 rounded-lg overflow-hidden hover:bg-gray-200 transition-colors group">
                <div className="p-4">
